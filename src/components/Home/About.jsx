...
function About() {
  const FadeInSection = ({ children, animationClass }) => {
    ...
    return (
      <div
        id={animationClass}
        className={`w-4/5 md:w-1/2 flex justify-center mb-8 relative transition-opacity duration-1000 ${
  ...
  return (
    <div className="flex flex-col relative md:flex-row justify-between items-center px-8 py-16 mt-32 gap-y-8 md:gap-x-12 max-w-screen-lg mx-auto">
      {/* Image Section */}
      <FadeInSection animationClass="fadeLeft">
        <img
          src={AboutImage}
      ...
      <div className="md:w-1/2 md:pl-6">
        <FadeInSection animationClass="FadeUpTop">
          <h2 className="text-2xl font-semibold ">ABOUT US______</h2>
        </FadeInSection>
        {/* <FadeInSection animationClass={"fadeUpTop"}> */}
          <p className="text-4xl font-bold mb-5">The Best Holidays Start Here!</p>
        {/* </FadeInSection> */}
